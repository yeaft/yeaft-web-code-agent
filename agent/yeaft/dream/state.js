 ...
 *
 *   1. Per-session control state (used to decide whether a group enters
 ...
 *      (`session/_no-session/.dream-state`) and uses the same accessor.
 *
 ...
 *
 * @param {string} root         — memory root, e.g. ~/.yeaft/memory
 * @param {string} scope        — `'session/<id>'` for triage failures,
