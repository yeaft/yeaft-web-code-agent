...
export class AdapterRouter extends LLMAdapter {
  ...
  /**
   * Replace the provider/model index after config.json changes.
   * Existing provider adapters are dropped because credentials, baseUrl,
   * protocol, or model ownership may have changed along with the list.
   *
