...
> This is the **1:1 chat mode powered by Claude Code CLI**. To swap Claude for GitHub Copilot CLI, see [Copilot Mode](./copilot-mode.md). For multi-VP parallel + cross-task memory, see [Yeaft Code Agent](./yeaft-group.md).
...
## Differences vs Copilot / Yeaft Code Agent
