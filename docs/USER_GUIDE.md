...
| Yeaft Group Mode | [Yeaft Group Mode](./guide/user/yeaft-group.md) (NEW) |
...
2. **Yeaft Group Mode** (multi-VP parallel collaboration) is the current main dev direction — wasn't documented
