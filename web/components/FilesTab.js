...
export default {
        ...
        <div class="file-tree-header vscode-header" v-else>
          <div class="vscode-folder-row">
            ...
            <div class="vscode-folder-actions" v-if="treeRootPath" @click.stop>
              ...
              <button v-if="!workspaceLocked" class="vscode-action-btn" @click="openFolderPicker" :title="$t('files.openFolder')">
  ...
  `,
  setup(props) {
    const liveStore = Vue.inject('workbench-store', null) || Pinia.useChatStore();
