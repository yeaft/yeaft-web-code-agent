...
export default {
  ...
  template: `
    <div class="global-toolbar">
      ...
      <div class="gt-right">
        <!-- Theme toggle -->
        <button class="gt-btn" @click="store.toggleTheme()" :title="store.theme === 'dark' ? $t('chat.sidebar.lightMode') : $t('chat.sidebar.darkMode')">
        ...
        <!-- Settings -->
        <button class="gt-btn" @click="settingsOpen = !settingsOpen" :title="$t('chat.sidebar.settings')">
        ...
        <!-- Add pane -->
        <button class="gt-btn gt-btn-add" v-if="store.splitPanes.length < 3" @click="store.addPane()" :title="$t('splitScreen.addPane')">
          <svg viewBox="0 0 24 24" width="16" height="16"><path fill="currentColor" d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
        </button>
        <!-- Merge (exit split) -->
        <button class="gt-btn gt-btn-merge" @click="mergePanes" :title="$t('splitScreen.merge')">
