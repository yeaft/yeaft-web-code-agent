...
export default {
  ...
  'unify.debug': '调试',
  'unify.debugTurns': '轮',
  'unify.debugTabToolStats': '工具统计',
  'unify.debugTabDream': 'Dream',
  'unify.debugTabRequestLog': '请求日志',
  'unify.dreamDebug.title': 'Dream 生命周期',
  'unify.dreamDebug.trigger': '触发',
  'unify.dreamDebug.status': '状态',
  'unify.dreamDebug.started': '开始',
  'unify.dreamDebug.finished': '结束',
  'unify.dreamDebug.time': '时间',
  'unify.dreamDebug.phase': '阶段',
  'unify.dreamDebug.call': '调用',
  'unify.dreamDebug.location': '生成位置',
  'unify.dreamDebug.result': '结果',
  'unify.dreamDebug.noLatest': '这个群组还没有记录到 Dream 检查。',
  'unify.dreamDebug.noEvents': '这个群组还没有 Dream 事件。',
  'unify.debugSearchPlaceholder': '搜索轮次、工具、提示词...',
  'unify.debugGroupFollowMain': '跟随主面板',
  'unify.debugGroupAll': '全部群组',
  'unify.debugAssistantResponse': 'Assistant 回复',
  'unify.debugViewAssistantResponse': '查看回复',
  'unify.turn': '第 {n} 轮',
  ...
  'unify.group.wizard.workDir': '工作目录',
  'unify.group.wizard.workDirPlaceholder': '/home/user/projects/app',
  'unify.group.wizard.workDirHint': '群组状态会以 .yeaft 目录保存在此路径下。留空则使用默认应用工作区。',
  ...
  'unify.group.settings.nav.memory': '群记忆',
  ...
  'unify.group.settings.memory.heading': '群记忆',
  'unify.group.settings.memory.help': '立即运行 dream 整理：读取上次以来的新消息，提取要点并合并进群的 summary，让 Resident 层能反映最新的对话。',
  'unify.group.settings.memory.runNow': '立即运行 dream',
  'unify.group.settings.memory.running': '运行中…',
  'unify.group.settings.memory.lastSuccess': '上次成功：{time} — 更新了 {count} 个目标。',
  'unify.group.settings.memory.lastError': '上次运行失败：{error}',
  ...
  'unify.vpTimeline.status.thinking': '思考中…',
  'unify.vpTimeline.status.streaming': '生成中',
  'unify.vpTimeline.status.tool': '调用工具中…',
  'unify.vpTimeline.status.error': '出错',
  'unify.vpTimeline.status.offline': '离线',
