...
export default {
  ...
  'unify.taskDetail.summary.aria': '任务摘要时间线',
  'unify.taskDetail.summary.title': '摘要时间线',
  'unify.taskDetail.summary.loading': '正在加载摘要历史…',
  'unify.taskDetail.summary.empty': '暂无摘要。',
  'unify.taskDetail.summary.error': '摘要加载失败：{error}',
  'unify.taskDetail.summary.showArchived': '显示已归档',
  'unify.taskDetail.related.aria': '关联任务',
  'unify.taskDetail.related.title': '关联任务',
  'unify.taskDetail.related.unlink': '取消关联',
  'unify.taskDetail.members.aria': '任务成员',
  'unify.taskDetail.members.title': '成员',
  'unify.taskDetail.members.abort': '中止',
  'unify.taskDetail.members.kick': '踢出',
  'unify.model': '模型',
