...
export default {
  ...
  'unify.featureDetail.ariaLabel': 'Task detail',
  'unify.featureDetail.replyTo': 'Reply in:',
  'unify.featureDetail.forkHint': 'No active thread — fork a new one to reply.',
  'unify.featureDetail.empty': 'No messages for this task yet.',
  'unify.featureDetail.threadPillHint': 'Open thread',
  // R6 G1a — summary timeline + relatedTaskIds + per-VP abort/kick
  'unify.featureDetail.summary.aria': 'Task summary timeline',
  'unify.featureDetail.summary.title': 'Summary timeline',
  'unify.featureDetail.summary.loading': 'Loading summary history…',
  'unify.featureDetail.summary.empty': 'No summaries yet.',
  'unify.featureDetail.summary.error': 'Summary history failed: {error}',
  'unify.featureDetail.summary.showArchived': 'Show archived',
  'unify.featureDetail.related.aria': 'Related tasks',
  'unify.featureDetail.related.title': 'Related tasks',
  'unify.featureDetail.related.unlink': 'Unlink',
  'unify.featureDetail.members.aria': 'Task members',
  'unify.featureDetail.members.title': 'Members',
  'unify.featureDetail.members.abort': 'Abort',
  'unify.featureDetail.members.kick': 'Kick',
  'unify.model': 'Model',
  ...
  'unify.debugTabToolStats': 'Tool Stats',
  'unify.debugTabDream': 'Dream',
  'unify.debugTabRequestLog': 'Request Log',
  'unify.dreamDebug.title': 'Dream lifecycle',
  'unify.dreamDebug.trigger': 'Trigger',
  'unify.dreamDebug.status': 'Status',
  'unify.dreamDebug.started': 'Started',
  'unify.dreamDebug.finished': 'Finished',
  'unify.dreamDebug.time': 'Time',
  'unify.dreamDebug.phase': 'Phase',
  'unify.dreamDebug.call': 'Call',
  'unify.dreamDebug.location': 'Location',
  'unify.dreamDebug.result': 'Result',
  'unify.dreamDebug.noLatest': 'No dream check has been recorded for this group yet.',
  'unify.dreamDebug.noEvents': 'No dream events yet for this group.',
  'unify.debugSearchPlaceholder': 'Search turns, tools, prompts...',
  'unify.debugGroupFollowMain': 'Follow main pane',
  'unify.debugGroupAll': 'All groups',
  'unify.debugAssistantResponse': 'Assistant response',
  'unify.debugViewAssistantResponse': 'View response',
  'unify.turn': 'Turn {n}',
  ...
  'unify.settings.tabs.search': 'Search',
  ...
  'unify.group.wizard.workDir': 'Work directory',
  'unify.group.wizard.workDirPlaceholder': '/home/user/projects/app',
  'unify.group.wizard.workDirHint': 'Group state is stored under this path as .yeaft. Leave empty to use the default app workspace.',
  ...
  'unify.group.settings.nav.memory': 'Memory',
  ...
  'unify.group.settings.memory.heading': 'Group memory',
  'unify.group.settings.memory.help': 'Run the dream consolidation now. Reads new messages since the last run, extracts facts, and merges them into the group\'s summary so the Resident layer reflects the latest conversation.',
  'unify.group.settings.memory.runNow': 'Run dream now',
  'unify.group.settings.memory.running': 'Running…',
  'unify.group.settings.memory.lastSuccess': 'Last run {time} — {count} target(s) updated.',
  'unify.group.settings.memory.lastError': 'Last run failed: {error}',
  ...
  'unify.feature.reject.invalid_vp_id': 'Message send failed: invalid speaker id.',
  'unify.feature.reject.empty_text': 'Message send failed: empty message.',
  'unify.feature.reject.text_too_long': 'Message send failed: text too long (max 16 KiB).',
  'unify.feature.reject.unknown': 'Message send failed.',
  ...
  'unify.vpTimeline.status.thinking': 'thinking…',
  'unify.vpTimeline.status.streaming': 'streaming',
  'unify.vpTimeline.status.tool': 'using tool…',
  'unify.vpTimeline.status.error': 'error',
  'unify.vpTimeline.status.offline': 'offline',
