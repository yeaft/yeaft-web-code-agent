...
describe('stop-hooks.js', () => {
  ...
  beforeEach(async () => {
    stopHooks = await import('../../agent/yeaft/stop-hooks.js');
  });
...
describe('skills.js', () => {
  ...
  beforeEach(async () => {
    skillsModule = await import('../../agent/yeaft/skills.js');
...
describe('tools/types.js', () => {
  ...
  beforeEach(async () => {
    const types = await import('../../agent/yeaft/tools/types.js');
...
describe('tools/registry.js', () => {
  ...
  beforeEach(async () => {
    const reg = await import('../../agent/yeaft/tools/registry.js');
...
describe('tools/mcp-tools.js', () => {
  ...
  beforeEach(async () => {
    mcpTools = await import('../../agent/yeaft/tools/mcp-tools.js');
  });
...
describe('tools/enter-worktree.js', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../../agent/yeaft/tools/enter-worktree.js');
...
describe('tools/exit-worktree.js', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../../agent/yeaft/tools/exit-worktree.js');
...
describe('tools/skill.js', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../../agent/yeaft/tools/skill.js');
...
describe('mcp.js', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../../agent/yeaft/mcp.js');
