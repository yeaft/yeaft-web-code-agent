 ...
 * SAME user message on disk. On reload `handleUnifyLoadHistory` then
...
import { runStopHooks } from '../../../agent/unify/stop-hooks.js';

let TEST_DIR;
let store;

beforeEach(() => {
  TEST_DIR = mkdtempSync(join(tmpdir(), 'unify-history-dedup-'));
