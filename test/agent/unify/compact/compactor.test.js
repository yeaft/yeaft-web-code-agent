 ...
 *
 * Compactor lives at `agent/unify/compact/compactor.js` and replaces the
 ...
 * from the bridge after `installUnifyRuntimeBridge`.
 */

import { describe, it, expect, vi } from 'vitest';
import { Compactor } from '../../../../agent/unify/compact/compactor.js';
