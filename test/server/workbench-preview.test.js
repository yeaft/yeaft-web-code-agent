...
const { createWorkbenchPreview, readWorkbenchPreview } = await import('../../server/workbench-preview.js');
const { registerUploadRoutes } = await import('../../server/routes/upload-routes.js');
