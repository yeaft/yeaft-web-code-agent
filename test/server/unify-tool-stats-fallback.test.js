 ...
 *
 * The web drawer requests `unify_fetch_tool_stats` and expects an agent-side
 * `unify_tool_stats` reply. If the selected agent is absent or offline, the
 * generic `unify_*` relay used to swallow the request silently, leaving the
...
describe('client-conversation.js — unify_fetch_tool_stats fallback', () => {
