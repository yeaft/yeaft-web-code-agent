 ...
 *
 * The header Dream button sends `yeaft_dream_trigger` through the generic
 * `yeaft_*` relay. If there is no selected/online agent, the request cannot
...
describe('client-conversation.js — yeaft_dream_trigger fallback', () => {
