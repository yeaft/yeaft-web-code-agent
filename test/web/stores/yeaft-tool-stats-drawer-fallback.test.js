/**
 * yeaft-tool-stats-drawer-fallback.test.js — pins the registered-list
 * fallback in YeaftToolStatsDrawer.rankedRows().
 *
...
import drawer from '../../../web/components/YeaftToolStatsDrawer.js';

function rankedRowsFor(stats) {
  return drawer.computed.rankedRows.call({ stats });
}

describe('YeaftToolStatsDrawer — rankedRows', () => {
